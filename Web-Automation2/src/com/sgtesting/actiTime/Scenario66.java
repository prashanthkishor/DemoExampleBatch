...
public class Scenario66 {
	...
	{
		return new Object[][] {{"smg Project"}};
	}
	@Test(priority=6,dataProvider="modifyproject")
	private static void modifyproject(String mdproj)
	{
		try
		{
			wb.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(3000);
			wb.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys(mdproj);
	...
	public Object[][] getmodifydetails()
	{
		return new Object[][] {{"Miakova1"}};
	}
	@Test(priority=7)
